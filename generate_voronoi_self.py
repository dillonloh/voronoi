...
image_path = './maps/warehouse.png'
path = './maps/warehouse-inverse.png'
...
with open('voronoi_self.pkl', 'wb') as f:
    pickle.dump(vor, f, pickle.HIGHEST_PROTOCOL)
    print('pickled')

with open('filtered_vertices_self.pkl', 'wb') as f:
    pickle.dump(z, f, pickle.HIGHEST_PROTOCOL)
    print('pickled 2')

print('plotting...')

fig = voronoi_plot_2d(vor, line_width=0.5, point_size=0.4, show_vertices=False, show_points=False)
